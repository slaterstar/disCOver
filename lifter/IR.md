...
Arithmetic will only use registers.
...
HOWEVER, the first operand MUST be a register, and the second operand can either be a register or immediate.
| Operations | Description | Example |
| ---------- | ----------- | ------- |
...
| XOR | Returns the eXclusive OR of two registers. | t2 = XOR(t1, t0)
